...
export default function Header({ juego, setJuego, onLoginClick }) {
    return (
        <header className="header">
            ...
            <div>
                ...
                <svg
                    className="icon icon-tabler icon-tabler-person"
                    fill="none"
                    height="24"
                    stroke="#525252"
                    strokeLinecap="round"
                ...
                >
                    ...
                    <path d="M12 14c-4.97 0-9 3-9 6h18c0-3-4.03-6-9-6z" />
                </svg>
            </div>
        </header>
    )
